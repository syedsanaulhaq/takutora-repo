         ...
         <?php if($skin == 'skin-v1'){ ?>
            <div class="gsc-image-content <?php print $el_class; ?>" <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
               ...
               <div class="box-content">
                  ...
                  <?php if($link){ ?>
                     <div class="read-more"><a class="btn-inline" <?php print $target ?> href="<?php print $link ?>"><i class="fas fa-arrow-right"></i><?php if($text_link){ ?><?php print $text_link ?><?php } ?></a></div>
                  <?php } ?>
