               ...
               <div class="content-inner">
                  <div class="icon-inner">
                     <?php if($link){ ?><a <?php print $target; ?> href="<?php print $link ?>"> <?php } ?>
                        <?php if($number){ ?><span class="icon-number"><span class="number"><?php print $number ?></span> <?php } ?>
                        <?php if($icon){ ?><span class="icon <?php print $icon ?>"></span> <?php } ?><?php if($number){ ?></span> <?php } ?>
