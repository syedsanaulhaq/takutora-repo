...
if(!class_exists('element_gva_image')):
   class element_gva_image{
      ...
      public static function render_content( $attr, $content = null ){
         ...
         $margin_top = '';
         if( $margin ){
            $margin_top = "style=\"margin-top:{$margin}\"";
         } 
         ...
         ob_start();
         ?>
            <div class="widget gsc-image<?php if(count($class_array) > 0) print (' ' . implode(' ', $class_array)) ?>" <?php print $margin_top ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
