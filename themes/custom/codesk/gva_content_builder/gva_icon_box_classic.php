...
if(!class_exists('element_gva_icon_box_classic')):
   class element_gva_icon_box_classic{
            ...
            'fields' => array(
              ...
              array(
               ...
               array(
                  ...
                  'title'     => 'Border Box',
                  'options'   => array(
                     ''                  => t('Disable Border Box'), 
                     'border-box-light'  => t('Border Box Light'),
                     'border-box-gray'   => t('Border Box Gray')
                  ),
                  'class'     => 'width-1-4',
               ),
               array(
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         if($border_box) $class[] = $border_box;
               ...
               <?php if(($icon || $image) && $icon_position != 'right'){ ?>
                  <div class="highlight-icon">
                     <span class="icon-inner <?php echo $icon_class_inner ?>">   
                        <span class="icon-container <?php print (empty($image) ? ' ' : 'image-inner'); ?> <?php print $icon_class ?>" <?php print $style_icon ?>>
                           <?php if($icon){ ?><span class="icon <?php print $icon ?>"></span> <?php } ?>
                           <?php if($image){ ?><span class="image icon"><img src="<?php print $image ?>" alt="<?php print strip_tags($title) ?>"/> </span> <?php } ?>
                        </span>
                     </span>
                  </div>
               <?php } ?>
